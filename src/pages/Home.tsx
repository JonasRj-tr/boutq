...
import { ShoppingBag, ChevronRight, Star, Truck, ShieldCheck, Heart, X, Plus, Minus, ArrowRight, Smartphone } from 'lucide-react';
    ...
    <div className="relative bg-brand-cream min-h-screen">
      ...
      <section className="bg-white/50 backdrop-blur-sm border-y border-brand-green/5 py-10">
        <div className="max-w-7xl mx-auto px-12 flex flex-wrap justify-center md:justify-between gap-10 opacity-60 text-[10px] uppercase tracking-[0.3em]">
          <div className="flex items-center gap-3"><Truck size={14} /> Frete para todo Brasil</div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-24">
            {filteredProducts.map((p, idx) => (
              ...
              >
                <div className="luxury-card aspect-[3/4] mb-8 relative group-hover:shadow-2xl transition-all duration-700">
                  <img 
                    src={p.image} 
                    alt={p.name}
                  ...
                  <button 
                    ...
                    className="absolute bottom-0 left-0 right-0 bg-brand-green text-white py-4 uppercase text-[10px] tracking-[0.3em] translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out"
                  >
                    Adicionar
                  </button>
                </div>
                <div className="flex flex-col gap-1 items-center pb-4">
                  ...
                  <span className="text-lg">{formatCurrency(p.price)}</span>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-12 grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
          <div className="relative order-2 lg:order-1">
            <div className="aspect-[4/5] bg-brand-cream relative z-10 w-full max-w-lg shadow-2xl">
              <img 
                src="https://images.unsplash.com/photo-1544467329-3091df010260?auto=format&fit=crop&q=80&w=1000" 
              ...
              <div className="p-10 bg-white border-t border-brand-green/5 shadow-[0_-20px_40px_rgba(45,71,57,0.03)]">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  {shippingInfo.price > 0 && (
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] uppercase tracking-[0.3em] opacity-40">Frete Correrios</span>
